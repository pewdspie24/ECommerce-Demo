...
USE onlinestore;
CREATE TABLE Customer (ID int(10) NOT NULL AUTO_INCREMENT, Gender varchar(255), Birth varchar(255), AccountNum varchar(255), ID3 int(10), CardID varchar(255), Date2 varchar(255), ID2 int(10), `Date` varchar(255) , PRIMARY KEY (ID), AccountID  int(10) NOT NULL, FullnameID  int(10) NOT NULL, PhoneID  int(10) NOT NULL, AddressID  int(10) NOT NULL);
CREATE TABLE Address (ID int(10) NOT NULL AUTO_INCREMENT, CustomerID int(10), Number varchar(255), Street varchar(255), District varchar(255), City varchar(255), PRIMARY KEY (ID));
CREATE TABLE Fullname (ID int(10) NOT NULL AUTO_INCREMENT, CustomerID int(10), FirstName varchar(255), LastName varchar(255), PRIMARY KEY (ID));
CREATE TABLE Account (ID int(10) NOT NULL AUTO_INCREMENT, CustomerID int(10), Email varchar(255), Password varchar(255), CreatedAt varchar(255), PRIMARY KEY (ID));
...
CREATE TABLE Cart (ID int(10) NOT NULL AUTO_INCREMENT, CustomerID int(10) NOT NULL, OrderID int(10), CreatedAt varchar(255), UpdatedAt varchar(255), TotalQuantity int(10) NOT NULL, TotalPrice float NOT NULL, PRIMARY KEY (ID));
...
CREATE TABLE Phone (ID int(10) NOT NULL AUTO_INCREMENT, CustomerID int(10), StatesNo varchar(255), Number varchar(255), PRIMARY KEY (ID));
...
ALTER TABLE Customer ADD CONSTRAINT FKAddress64710 FOREIGN KEY (AddressID) REFERENCES Address (ID);
ALTER TABLE Customer ADD CONSTRAINT FKFullname417515 FOREIGN KEY (FullnameID) REFERENCES Fullname (ID);
ALTER TABLE Customer ADD CONSTRAINT FKAccount437857 FOREIGN KEY (AccountID) REFERENCES Account (ID);
...
ALTER TABLE Customer ADD CONSTRAINT FKPhone193160 FOREIGN KEY (PhoneID) REFERENCES Phone (ID);
