...
USE onlinestore;
CREATE TABLE Customer (ID int(10) NOT NULL AUTO_INCREMENT, Gender varchar(255), Birth varchar(255), AccountNum varchar(255), ID3 int(10), CardID varchar(255), Date2 varchar(255), ID2 int(10), `Date` varchar(255) , AccountId int(10) NOT NULL, AddressID int(10) NOT NULL, FullnameID int(10) NOT NULL, PhoneID int(10) NOT NULL, PRIMARY KEY (ID));
CREATE TABLE Address (ID int(10) NOT NULL AUTO_INCREMENT, Number varchar(255), Street varchar(255), District varchar(255), City varchar(255), PRIMARY KEY (ID));
CREATE TABLE Fullname (ID int(10) NOT NULL AUTO_INCREMENT, FirstName varchar(255), LastName varchar(255), PRIMARY KEY (ID));
CREATE TABLE Phone (ID int(10) NOT NULL AUTO_INCREMENT, StatesNo varchar(255), Number varchar(255), PRIMARY KEY (ID));
CREATE TABLE Account (ID int(10) NOT NULL AUTO_INCREMENT, Email varchar(255), Password varchar(255), CreatedAt varchar(255), PRIMARY KEY (ID));
CREATE TABLE `Order` (ID int(10) NOT NULL AUTO_INCREMENT, CartID int(10) NOT NULL, PaymentID int(10) NOT NULL, CustomerID int(10) NOT NULL, `Date` varchar(255), PRIMARY KEY (ID));
CREATE TABLE Cart (ID int(10) NOT NULL AUTO_INCREMENT, CustomerID int(10) NOT NULL, CreatedAt varchar(255), UpdatedAt varchar(255), TotalQuantity int(10) NOT NULL, TotalPrice float NOT NULL, PRIMARY KEY (ID));
...
CREATE TABLE BillOnline (ID int(10) NOT NULL AUTO_INCREMENT, CustomerID int(10) NOT NULL, OrderID int(10) NOT NULL, TotalPrice float NOT NULL, DateCreate varchar(255), TotalDiscount float NOT NULL, PRIMARY KEY (ID));
...
ALTER TABLE Customer ADD CONSTRAINT FKCustomer64710 FOREIGN KEY (AddressID) REFERENCES Address (ID);
ALTER TABLE Customer ADD CONSTRAINT FKCustomer417515 FOREIGN KEY (FullnameID) REFERENCES Fullname (ID);
ALTER TABLE Customer ADD CONSTRAINT FKCustomer437857 FOREIGN KEY (AccountID) REFERENCES Account (ID);
ALTER TABLE Customer ADD CONSTRAINT FKCustomer193160 FOREIGN KEY (PhoneID) REFERENCES Phone (ID);
...
ALTER TABLE `Order` ADD CONSTRAINT FKOrder92266 FOREIGN KEY (CartID) REFERENCES Cart (ID);
...
ALTER TABLE BillOnline ADD CONSTRAINT FKBillOnline443398 FOREIGN KEY (OrderID) REFERENCES `Order` (ID);
