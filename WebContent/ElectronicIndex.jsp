    ...
    <div id="main">
        ...
        <div id="content">
            <div class="row">
                <div class="col-md-2">
                    <div class="bg-dark mb-3">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item active"><a href="ElectronicIndex.jsp" style="color: #000;">Electronic</a></li>
                ...
                <div class="col-9">
                    <div class="row">
                        <c:forEach items="${listElectronicProducts}" var="o">
                            <div class="col-12">
                                <div class="card">
                                    <img class="card-img-top" src="${o.image}" alt="img product">
                                    <div class="card-body">
                                        <h4 class="card-title"><a href="productDetail.jsp" title="View Product">${o.name}</a></h4>
                                        <div class="row">
                                            <div class="col">
