...
<div class="toast-body" id="toastbody">
                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-text">${product.price}đ</h5>
                            <div class="btn btn-primary text-center" onclick="addshoes(${product.ID}, 1, 'shoes')">Add
                                to Cart</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-text">${product.price}đ</h5>
                            <div class="btn btn-primary text-center" onclick="addclothes(${product.ID}, 1, 'clothes')">Add
                                to Cart</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-text">${product.price}đ</h5>
                            <div class="btn btn-primary text-center" onclick="addelectronic(${product.ID}, 1, 'eletronic')">Add
                                to Cart</div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function addshoes(shoesItemId, quantity, type) {
            $.ajax({
                url: 'addshoes',
                type: 'POST',
                data: {
        ...
        function addclothes(clothesItemId, quantity, type) {
            $.ajax({
                url: 'addclothes',
                type: 'POST',
                data: {
        ...
        function addelectronic(electronicItemId, quantity, type) {
            $.ajax({
                url: 'addelectronic',
                type: 'POST',
                data: {
